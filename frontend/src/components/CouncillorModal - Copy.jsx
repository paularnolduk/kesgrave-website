...
const CouncillorModal = ({ councillorId, isOpen, onClose }) => {
  ...
  return (
    <div 
      className="councillor-modal-backdrop"
      onClick={handleBackdropClick}
      role="dialog"
      aria-modal="true"
      aria-labelledby="councillor-modal-title"
    >
      <div className="councillor-modal-container">
            ...
            <>
              ...
              <div className="councillor-modal-header">
                {councillor.image_url && (
                  <div 
                    className="councillor-modal-image"
                    style={{ backgroundImage: `url(${councillor.image_url})` }}
                    role="img"
                    aria-label={`Photo of ${councillor.name}`}
                  />
                )}
                <div className="councillor-modal-overlay">
                  <div className="councillor-modal-header-content">
                    {/* Ward Tags */}
              ...
              <div className="councillor-modal-body">
                ...
                {/* Social Links */}
                {councillor.social_links && councillor.social_links.length > 0 && (
                  <section className="councillor-modal-section">
                    <h2>Social Media & Links</h2>
                    <div className="councillor-social-links">
                      {councillor.social_links.map((link, index) => (
                        <a
                          key={index}
                          href={link.url}
                          target="_blank"
